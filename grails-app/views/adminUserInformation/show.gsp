...
<div class="col-lg-12">
    <g:link action="edit" id="${adminUserInstance?.id}" controller="adminUserInformation" class="btn btn-primary navbar-btn">Edit</g:link>
    <g:link action="delete" id="${adminUserInstance?.id}" controller="adminUserInformation" class="btn btn-primary navbar-btn">Delete</g:link>
