...
<div class="col-lg-6" style="margin-left: 12%">
    <g:link action="edit" id="${specialBrandInstance?.id}" controller="specialBrand" onclick="return confirm('Are you sure want to confirm?')" class="btn btn-primary navbar-btn">Edit</g:link>
