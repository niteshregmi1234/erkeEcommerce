...
<div class="col-sm-6">
    <g:link action="edit" id="${homeContentInstance?.id}" controller="homeContent" onclick="return confirm('Are you sure want to confirm?')" class="btn btn-primary navbar-btn">Edit</g:link>
