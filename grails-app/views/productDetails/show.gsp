...
<div class="col-lg-12">
    <g:link action="edit" id="${productDetailsInstance?.id}" controller="productDetails" class="btn btn-primary navbar-btn">Edit</g:link>
    <g:link action="delete" id="${productDetailsInstance?.id}" controller="productDetails" class="btn btn-primary navbar-btn">Delete</g:link>
