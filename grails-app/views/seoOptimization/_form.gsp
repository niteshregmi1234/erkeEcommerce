    ...
    <div class="col-lg-12">
        <div class="form-group ">
            <label class="control-label col-sm-2" for="robots">Google Bots:</label>

            <div class="col-sm-4">
                <g:textField name="robots" id="robots" value="${seoOptimizationInstance?.googleBots}" class="form-control"/>
                %{--<g:formatDate format="yyyy-MM-dd" class="form-control"/>--}%
                %{--<input type="email" class="form-control" id="email" placeholder="Enter email">--}%
            </div>
        </div>
