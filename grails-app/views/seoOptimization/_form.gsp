    ...
    <div class="col-lg-12">
        <div class="form-group ">
            <label class="control-label col-sm-2" for="googleBots">Google Bots:</label>

            <div class="col-sm-4">
                <g:textField name="googleBots" id="googleBots" value="${seoOptimizationInstance?.googleBots}" class="form-control"/>
                %{--<g:formatDate format="yyyy-MM-dd" class="form-control"/>--}%
                %{--<input type="email" class="form-control" id="email" placeholder="Enter email">--}%
            </div>
        </div>
    ...
    <div class="col-lg-12">
        <div class="form-group ">
            ...
            <div class="col-sm-4">
                <g:textField name="title" id="title" value="${seoOptimizationInstance?.title}" class="form-control"/>
                %{--<g:formatDate format="yyyy-MM-dd" class="form-control"/>--}%
                %{--<input type="email" class="form-control" id="email" placeholder="Enter email">--}%
            </div>
        </div>
    ...
    <div class="col-lg-12">
        <div class="form-group ">
            <label class="control-label col-sm-2" for="googleSiteVerification">Google Site Verification:</label>

            <div class="col-sm-4">
                <g:textField name="googleSiteVerification" id="googleSiteVerification" value="${seoOptimizationInstance?.googleSiteVerification}" class="form-control"/>
                %{--<g:formatDate format="yyyy-MM-dd" class="form-control"/>--}%
                %{--<input type="email" class="form-control" id="email" placeholder="Enter email">--}%
            </div>
        </div>
