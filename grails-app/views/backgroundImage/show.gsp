...
<div class="col-lg-12" style="margin-left: 12%">
    <g:link action="edit" id="${backgroundImageInstance?.id}" controller="backgroundImage" onclick="confirm('Are you sure want to confirm?')" class="btn btn-primary navbar-btn">Edit</g:link>
