...
<table id="example" class="display nowrap" cellspacing="0" width="100%">
    ...
    <tbody>
    <g:each in="${productCategoryList}" var="list" status='i'>
        <tr>
            <td>${i+1}</td>
            <td> <g:link action="show" id="${list?.id}" controller="productCategory" class="btn btn-primary btn-sm">view</g:link></td>
