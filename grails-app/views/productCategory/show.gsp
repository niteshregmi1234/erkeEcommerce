...
<div class="col-lg-12">
    <g:link action="edit" id="${productCategoryInstance?.id}" controller="productCategory" onclick="return confirm('Are you sure want to confirm?')" class="btn btn-primary navbar-btn">Edit</g:link>
    <g:link action="delete" id="${productCategoryInstance?.id}" controller="productCategory" onclick="return confirm('Are you sure want to confirm?')" class="btn btn-primary navbar-btn">Delete</g:link>
