    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li><g:link action="specifiedProducts" params="[category:productCategory.urlName,subCategorySpecify:productSubCategory.productSubCategorySpecify.urlName]" controller="endUser">${productSubCategory.productSubCategorySpecify.specificationName}</g:link>
                </li>
