...
<div id="content">
 ...
 _________________________________________________________ -->
                                    ...
                                    function filterPrice(){
                                        ...
                                        for(var i=0;i<idList.length;i++) {
                                            ...
                                            if(price<minPrice){
                                                ...
                                                if(brandList!='' && subCategoryList!='' && discountList!=''){
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products" id="myList">
                        <g:each in="${productList}" var="list" status="i">
                            <g:if test="${list.productDetails.isSale==false}">
                                <div class="grid-products" id="product${list.id}" data-discount="${list.productDetails.discountPercentage}" data-subCategory="${list.productDetails.productSubCategory.id}" data-productBrand="${list.productDetails.productBrand.id}">
                            ...
                            <g:if test="${list.productDetails.isSale==true}">
                                <div class="grid-products" id="product${list.id}" data-price="${list.productDetails.price}" data-discount="${list.productDetails.discountPercentage}" data-subCategory="${list.productDetails.productSubCategory.id}" data-productBrand="${list.productDetails.productBrand.id}">
                                    <input type="hidden" name="price" id="price${list.id}" value="${list.productDetails.price}">
                                    <input type="hidden" name="productId" value="${list.id}">
                                    <input type="hidden" name="brandId" id="brand${list.id}" value="${list.productDetails.productBrand.id}">
                                    <input type="hidden" name="subCategoryId" id="subCategory${list.id}" value="${list.productDetails.productSubCategory.id}">
                    ...
                    <ul class="pagination">
                        <li><g:paginate next=" &raquo;" prev="&laquo;;" action="specifiedProducts" params="[category:productCategory.categoryId,subCategorySpecify:productSpecifyInstance.id]" controller="endUser" total="${countPaginate}"/></li>
                    </ul>
