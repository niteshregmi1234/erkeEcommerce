...
<div id="content">
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li>${productBrandInstance.brandName}</li>
            </ul>
 ...
 _________________________________________________________ -->
        ...
        <div class="col-md-9">
            ...
            <div class="pages">
            <ul class="pagination">
                <li><g:paginate next=" &raquo;" prev="&laquo;;" action="offerBrand"  controller="endUser" params="[id:productBrandInstance.id]" total="${countPaginate}"/></li>
            </ul>
