...
<div class="col-lg-12">
    <g:link action="edit" id="${paymentMethodInstance?.id}" controller="paymentMethod" class="btn btn-primary navbar-btn">Edit</g:link>
    <g:link action="delete" id="${paymentMethodInstance?.id}" controller="paymentMethod" class="btn btn-primary navbar-btn">Delete</g:link>
