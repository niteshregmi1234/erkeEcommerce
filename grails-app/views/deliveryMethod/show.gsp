...
<div class="col-lg-12">
    <g:link action="edit" id="${deliveryMethodInstance?.id}" controller="deliveryMethod" class="btn btn-primary navbar-btn">Edit</g:link>
    <g:link action="delete" id="${deliveryMethodInstance?.id}" controller="deliveryMethod" class="btn btn-primary navbar-btn">Delete</g:link>
